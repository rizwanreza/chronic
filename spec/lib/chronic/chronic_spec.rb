...
describe Chronic do
  ...
  it "test_post_normalize_am_pm_aliases" do
    ...
    tokens[1].tags[0].type.should == :morning

    tokens = Chronic.dealias_and_disambiguate_times(tokens, {})

    tokens[1].tags[0].type.should == :am
  ...
  it "test_tokenize_ignores_trailing_tokens" do
